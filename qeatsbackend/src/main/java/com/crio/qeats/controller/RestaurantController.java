...
/*
 * checking wheather longitude or latitude are valid here or in the findAllRestaurantsCloseBy 1. if
 * it is done here, then it will sure that request is bad 2. if it is done in the {@Code
 * findAllRestaurantsCloseBy} then this leads to an ambiguity like a. may be hotel doesnot exist or may be bad request.
 */
